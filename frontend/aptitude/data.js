const aptitudeTopics = [
    {
        ...
        "icon": "\u26a1",
        "xp_reward": 150,
        "formula_sheet": "### \ud83d\udcc4 Master Cheat Sheet: Speed Math\n\n# Speed Math Notes\n\n## Topic: Squares (upto 125)\n\n### Case I: Numbers ending with digit '5'\nFor instance: 15, 25, 35, 45, 55, etc.\nFor this, we simply:\n1. Write $5^2 = 25$ at the end.\n2. Multiply the tens digit with its succeeding number.\n- $15^2 = 225$\n- $25^2 = 625$\n- $35^2 = 1225$\n- $45^2 = 2025$\n- $55^2 = 3025$\n\n### Upto 125 Squares\nWe calculate squares based on:\n- Nearer to 100\n- Nearer to 50\n\n### Case II: Numbers nearer to 50\n**a) Numbers below 50 (e.g., 47, 48, 41, etc...)**\n- **Step 1:** Calculate the difference with 50 (i.e., $47 = 50 - 3$). Consider the square of this difference (i.e., $3^2 = 09$) at the answer's unit place.\n- **Step 2:** Now consider subtracting the difference from 25 (i.e., $25 - 3 = 22$). \n- **Final Answer:** 2209 (Note: Step 1 result should be 2-digits).\n\n**b) Numbers above 50 (e.g., 51, 52, ... 99)**\n- **Step 1:** Consider the add-on numbers after 50. For 53, it is $50 + 3$. Consider $3^2 = 09$.\n- **Step 2:** Add the add-on to 25. $\\Rightarrow 25 + 3 = 28$.\n- **Final Answer:** $53^2 = 2809$.\n\n*Summary:* \nAt Step 1, compare with 50 (for squares). \nAt Step 2, compare with 25 (just the number).\n\n### Case III: Numbers nearer to 100\nFor instance: 101, 102, ... 150, and 96, 77, ... 99.\n- **Step 1:** Consider the difference with 100.\n  - For 94: $100 - 6 \\Rightarrow$ consider $6^2 = 36$ at the end.\n  - For 107: $100 + 7 \\Rightarrow$ consider $7^2 = 49$ at the end.\n- **Step 2:** Add/subtract the difference with 100 from the whole number itself.\n  - For 94: $94 - 6 = 88 \\Rightarrow 94^2 = 8836$.\n  - For 107: $107 + 7 = 114 \\Rightarrow 107^2 = 11449$.\n\n*Note:* If the answer in Step 1 exceeds 2-digits, consider the carry and add it up to the Step-2's answer.\n\n---\n\n## Topic: Cubes\n- $1^3 = 1$\n- $2^3 = 8$\n- $3^3 = 27$\n- $4^3 = 64$\n- $5^3 = 125$\n- $6^3 = 216$\n- $7^3 = 343$\n- $8^3 = 512$\n- $9^3 = 729$\n- $10^3 = 1000$\n- $11^3 = 1331$\n- $12^3 = 1728$\n- $13^3 = 2197$\n- $14^3 = 2744$\n- $15^3 = 3375$\n\n---\n\n## Topic: Cube Roots\nLet us write the unit digits of cubes from 1 to 10:\n- $1^3 \\rightarrow 1$\n- $2^3 \\rightarrow 8$\n- $3^3 \\rightarrow 7$\n- $4^3 \\rightarrow 4$\n- $5^3 \\rightarrow 5$\n- $6^3 \\rightarrow 6$\n- $7^3 \\rightarrow 3$\n- $8^3 \\rightarrow 2$\n- $9^3 \\rightarrow 9$\n- $10^3 \\rightarrow 0$\n\nNotice that 1, 4, 6, 9, 0 end their cubes with the same numbers.\nBut for 2, it ends with 8, and for 8 it ends with 2.\nFor 3, it ends with 7, and for 7 it ends with 3.\n\n### Finding Cube Roots (Example: $\\sqrt[3]{97336}$)\n- **Step 1:** Consider the given number. Here, the number ends with 6. Therefore, the cube root also ends with 6.\n- **Step 2:** As we are finding the cube root (i.e., '3'), don't consider the last 3-digits in the given number (i.e., ignore 336). We are left with 97.\n- **Step 3:** Now, 97 is in between $4^3 = 64$ and $5^3 = 125$. Hence, we consider the preceding perfect cube (which is 4).\n- **Final Answer:** Combining Step 3 & Step 1 answers $\\Rightarrow 46$.\n\n*Similar Examples:*\n- $\\sqrt[3]{29791} = 31$\n- $\\sqrt[3]{195112} = 58$\n\n---\n\n## Topic: Square Roots\nUnit digits of squares:\n- $1^2 \\rightarrow 1$, $9^2 \\rightarrow 1$\n- $2^2 \\rightarrow 4$, $8^2 \\rightarrow 4$\n- $3^2 \\rightarrow 9$, $7^2 \\rightarrow 9$\n- $4^2 \\rightarrow 6$, $6^2 \\rightarrow 6$\n- $5^2 \\rightarrow 5$\n- $10^2 \\rightarrow 0$\n\n### Finding Square Roots (Example: $\\sqrt{7569}$)\n- **Step 1:** Check the unit digit. Here it is 9. The square root can end with either 3 or 7.\n- **Step 2:** Now don't consider the last 2-digits. We are left with 75. 75 lies between $8^2 = 64$ and $9^2 = 81$. We consider the preceding value (8). So the answer is either 83 or 87.\n- **Step 3:** Now we check the nearest square for 75 (i.e., is 75 nearer to $8^2$ or $9^2$?). It is nearer to $9^2$, so we consider the higher value.\n- **Final Answer:** 87.\n\n---\n\n## Topic: Fractions\nWhenever we want to know the percentage of a fraction, we multiply it by 100. \nExample: $\\frac{1}{2} \\times 100 = 50\\%$. \nConversely, $50\\% = \\frac{50}{100} = \\frac{1}{2}$.\n\nFor improper fractions like $\\frac{3}{2}, \\frac{5}{3}, \\frac{7}{6}$, we don't need to multiply by 100. We can simply separate them: \n$\\frac{3}{2} = \\frac{2}{2} + \\frac{1}{2} = 1 + \\frac{1}{2}$.\n\n### Important Proper Fractions to Percentages\n- $1/2 = 50\\%$\n- $1/3 = 33.33\\%$\n- $2/3 = 66.66\\%$\n- $1/4 = 25\\%$\n- $3/4 = 75\\%$\n- $1/5 = 20\\%$\n- $2/5 = 40\\%$\n- $3/5 = 60\\%$\n- $4/5 = 80\\%$\n\n- $1/6 = 16.66\\%$\n- $5/6 = 83.33\\%$\n\n- $1/7 = 14.28\\%$\n- $2/7 = 28.57\\%$\n- $3/7 = 42.85\\%$\n- $4/7 = 57.14\\%$\n- $5/7 = 71.42\\%$\n- $6/7 = 85.71\\%$\n\n- $1/8 = 12.5\\%$\n- $3/8 = 37.5\\%$\n- $5/8 = 62.5\\%$\n- $7/8 = 87.5\\%$\n\n- $1/12 = 8.33\\%$\n- $5/12 = 41.66\\%$\n- $7/12 = 58.33\\%$\n- $11/12 = 91.66\\%$\n\n### The 1/9 and 1/11 Rules\nFor $1/9$ fractions, we multiply the numerator by 11.11:\n- $1/9 = 11.11\\%$\n- $2/9 = 22.22\\%$\n- $3/9 = 33.33\\%$\n- $4/9 = 44.44\\%$\n- $5/9 = 55.55\\%$\n- $6/9 = 66.66\\%$\n- $7/9 = 77.77\\%$\n- $8/9 = 88.88\\%$\n\nFor $1/11$ fractions, we multiply the numerator by 9.09:\n- $1/11 = 9.09\\%$\n- $2/11 = 18.18\\%$\n- $3/11 = 27.27\\%$\n- $4/11 = 36.36\\%$\n- $5/11 = 45.45\\%$\n- $6/11 = 54.54\\%$\n- $7/11 = 63.63\\%$\n- $8/11 = 72.72\\%$\n- $9/11 = 81.81\\%$\n- $10/11 = 90.90\\%$",
        "questions": []
    },
    {
        "id": 2,
        ...
        "icon": "\ud83d\udcaf",
        "xp_reward": 100,
        "formula_sheet": "### \ud83d\udcc4 Master Cheat Sheet: Percentages (PDF)\n\n# Percentages\n\n## Key Concepts and Shortcuts\n* In Percentages, knowing some fractions will make calculating percentages easier.\n  * For example: $28.5\\% \\text{ of } 1400 = \\frac{2}{7} \\times 1400 = 400$\n* **Rule of Symmetry**: $a\\% \\text{ of } b = b\\% \\text{ of } a$\n  * For example, $13\\% \\text{ of } 200 = 200\\% \\text{ of } 13$\n* **Finding 10% and 1%**:\n  * We get $10\\%$ of any number by placing a decimal point before the unit digit.\n  * We get $1\\%$ of any number by placing a decimal point before the tens digit.\n  * For instance:\n    * $10\\% \\text{ of } 7432 = 743.2$\n    * $1\\% \\text{ of } 7432 = 74.32$\n* We get other values by using these $10\\%, 1\\%$ techniques.\n  * For instance, $21\\% \\text{ of } 6400$:\n    * $10\\% \\text{ of } 6400 = 640.0$\n    * We get $20\\% \\text{ of } 6400 = 640 \\times 2 = 1280$\n    * We get $20\\%$ and add on $1\\%$ (i.e. $21\\%$): $1280 + 64 = 1344$\n  * Similarly, $19\\% \\text{ of } 7200$:\n    * $20\\% - 1\\% = 1440 - 72 = 1368$\n* **Highly Important Concept**:\n  * Logically, if an entity is increased by $x\\%$ and again after increasing, then decreased with the same $x\\%$ percent we finally end up with the loss.\n  * ($\\uparrow \\downarrow \\text{ or } \\downarrow \\uparrow \\Rightarrow \\text{Finally loss}$)\n  * For any $10^{\\text{th}}$ multiple increase and decrease, we loss in square format.\n  * For instance, if:\n    * $10\\% \\uparrow\\downarrow \\Rightarrow \\text{Loss } 1\\% (1.0)^2$\n    * $20\\% \\uparrow\\downarrow \\Rightarrow \\text{Loss } 4\\% (2.0)^2$\n    * $30\\% \\uparrow\\downarrow \\Rightarrow \\text{Loss } 9\\% (3.0)^2$\n    * $5\\% \\uparrow\\downarrow \\Rightarrow \\text{Loss } 0.25\\% (0.5)^2$\n    * $12\\% \\uparrow\\downarrow \\Rightarrow \\text{Loss } 1.44\\% (1.2)^2$\n* If increased and decreased with same percentage (vice versa), then the overall decrease will be its square.\n* If increased with same percentage two times:\n  * ($\\uparrow \\uparrow \\Rightarrow \\text{Overall increase}$)\n  * $10\\% \\uparrow \\uparrow \\Rightarrow 10+10+(1.0)^2 = 21\\%$\n  * $20\\% \\uparrow \\uparrow \\Rightarrow 20+20+(2.0)^2 = 44\\%$\n  * Similarly it increases like the pattern of two times adding up and finally adding up with its square value.\n* If decreased with same percentage two times:\n  * ($\\downarrow \\downarrow \\Rightarrow \\text{Overall decrease}$)\n  * $10\\% \\downarrow \\downarrow \\Rightarrow 10+10 - (1.0)^2 = 19\\%$\n  * $12\\% \\downarrow \\downarrow \\Rightarrow 12+12 - (1.2)^2 = 22.56\\%$\n  * Similarly it decreases like adding itself two times and subtracting its square from it.\n* **Questioning Pattern Types**:\n  1. Initial value and Percentage will be given, we need to find final value.\n  2. Initial value and final value will be given, we need to find Percentage.\n  3. Percentage and final value will be given, we need to find Initial value.\n  * If Initial value and Percentage are known (find final): Solving methodology = calculation\n  * If Initial value and final value are known (find %): Solving methodology = Fraction\n  * If Percentage and final value are known (find initial): Solving methodology = Equation\n* **Comparisons**:\n  * If there are two numbers $A=60, B=80$ (say).\n  1. $A$ is what $\\%$ of $B = (A/B) \\times 100$\n  2. $B$ is what $\\%$ of $A = (B/A) \\times 100$\n  3. $A$ is how much $\\%$ less than $B = (\\frac{\\text{diff}}{B}) \\times 100$\n  4. $B$ is how much $\\%$ more than $A = (\\frac{\\text{diff}}{A}) \\times 100$",
        "questions": [
            {
    ...
    },
    {
        ...
        "icon": "\ud83d\udcc8",
        "xp_reward": 110,
        "formula_sheet": "### \ud83d\udcc4 Master Cheat Sheet: Profit & Loss (PDF)\n\n# Profit and Loss\n\n**Terminology in Profit and Loss:**\n1. Cost Price (C.P) $\\rightarrow$ $100\\%$\n2. Selling Price (S.P) $\\rightarrow$ C.P + P (or) C.P - L\n   * If C.P < S.P, it is Profit.\n   * If C.P > S.P, it is Loss.\n3. Profit (P) $\\rightarrow$ Difference between C.P and S.P\n4. Loss (L) $\\rightarrow$ Difference between C.P and S.P\n5. Profit % (P%) = $\\frac{P}{C.P} \\times 100$\n6. Loss % (L%) = $\\frac{L}{C.P} \\times 100$\n\n* Everything will be calculated only on cost price, not on selling price.\n* Cost price is always considered as $100\\%$.\n* Profit and loss is analogical to percentages. Here also, we can have three types:\n  1. Initial value (cost price).\n  2. Percentage of profit/loss.\n  3. Final value (selling price).\n* Process of finding one value, when the other two is given.\n\n**Miscellaneous & Shortcuts:**\n* Three successive discounts of $10\\%, 20\\%$ and $30\\%$ is equal to a single discount of $49.6\\%$. (Marked Price = $100$ $\\rightarrow$ 1st discount $10\\% = 90$ $\\rightarrow$ 2nd discount $20\\% = 72$ $\\rightarrow$ 3rd discount $30\\% = 50.4$. Total discount = $100 - 50.4 = 49.6\\%$)\n* **Important Note:** If a person purchased two items/entities with equal cost price and sold one of it with equal profit% and another one with same equal loss%. Then the answer will end with NO profit / NO loss.\n* **Important Note:** If the selling prices of two items are same and one item is sold with same percentage of loss and another with same percentage of profit. Then we will end up with loss of $(\\% \\text{ of Profit/Loss} / 10)^2$. i.e if profit and loss% = $20\\%$, overall loss = $(20/10)^2 = 4\\%$.\n* **Important Note:** If cost price of $x$ items is equal to selling price of $y$ items. Then Profit/Loss $\\rightarrow$ Reverse the terms and equate C.P $\\leftrightarrow$ S.P. Then, consider the greatest one and generalize the profit.\n* **Important Note:** If selling prices is given in the context of both loss and profit are equal. Then, cost price = $\\frac{SP_1 + SP_2}{2}$ = averages of selling prices. C.P lies in between selling prices.\n* **Important Note:** When a discount is given and while discounting the profit % is also given, then what is the profit/loss % when no discount is given. Everything will be calculated on marked price and selling price.\n* **Important Note:** A situation that is the seller is selling the items with cheating in weighing. In this case, the seller will always remain in profit and he portrays that he is selling to the same price that he bought. Then Profit % = $\\frac{\\text{Diff.}}{\\text{False wt.}} \\times 100$.\n* **Special cases:** Convert percentages into fractions for simplified calculation (e.g. $14.28\\% = 1/7$, $28.57\\% = 2/7$).\n* **Important Note:** A merchant buys an item of quantity with a price and again an item with other price. Overall profit/loss can be found by finding out the differences between two purchase prices and comparing it with the overall selling prices (or using standard weighted average).",
        "questions": [
            {
                "difficulty": "intermediate",
    ...
    },
    {
        ...
        "icon": "\u2696\ufe0f",
        "xp_reward": 100,
        "formula_sheet": "### \ud83d\udcc4 Master Cheat Sheet: Averages (PDF Placeholder)\n\n# Averages\n\n## Basic Formulas\n- **Average** = Sum of obs. / No. of obs.\n- **No. of obs** = Sum of obs. / Avg\n- **Sum** = No. of obs * Avg\n\n## Core Concepts\n- **Equality Concept**: If every value is equal, Each value = Average.\n- Average is a concept of Assumption, not reality.\n- **Replacement**: A concept in Averages, that in a set an element is removed and adds new element which causes a replacement and this replacement causes averages differences.\n- Averages is all about maintaining and distributing equality.\n\n## Weighted Average\n- Weighted Average is used when there are entities with different types and different count of entities.\n- Formula: `(A1N1 + A2N2 + ...) / (N1 + N2 + ...)`\n- You can convert the number of corresponding entities into Ratios in the formula: `N_i = R_i`\n\n## Consecutive Numbers & Progressions\n- If there is a common difference among the observations: \n  - `Average = (first obs. + last obs.) / 2`\n  - OR exactly the middle number.\n- **Average of first 'n' even numbers** = `n + 1`\n- **Average of first 'n' odd numbers** = `n`\n\n## Important Notes\n1. If every element in the observation is increased equally, Then the average will increase by that value (Previous Avg + increased value).\n2. If anything implies to each person/element, Then follow the mathematical operation in the question on the average directly (e.g. multiplied by 3, new average is Old Avg * 3).",
        "questions": [
            {
                "difficulty": "intermediate",
